...
/**
*public static it.unimi.dsi.fastutil.bytes.Byte2IntMap it.unimi.dsi.fastutil.bytes.Byte2IntMaps.singleton(java.lang.Byte,java.lang.Integer)
*/ 
...
/**
*public static it.unimi.dsi.fastutil.bytes.Byte2IntMap it.unimi.dsi.fastutil.bytes.Byte2IntMaps.synchronize(it.unimi.dsi.fastutil.bytes.Byte2IntMap)
*/ 
public static it.unimi.dsi.fastutil.bytes.Byte2IntMap synchronize(it.unimi.dsi.fastutil.bytes.Byte2IntMap p0){
	return it.unimi.dsi.fastutil.bytes.Byte2IntMaps.synchronize(p0);
}
/**
*public static it.unimi.dsi.fastutil.bytes.Byte2IntMap it.unimi.dsi.fastutil.bytes.Byte2IntMaps.unmodifiable(it.unimi.dsi.fastutil.bytes.Byte2IntMap)
*/ 
