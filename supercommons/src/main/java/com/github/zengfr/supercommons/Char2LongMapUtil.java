...
/**
*public static it.unimi.dsi.fastutil.chars.Char2LongMap it.unimi.dsi.fastutil.chars.Char2LongMaps.singleton(java.lang.Character,java.lang.Long)
*/ 
...
/**
*public static it.unimi.dsi.fastutil.chars.Char2LongMap it.unimi.dsi.fastutil.chars.Char2LongMaps.synchronize(it.unimi.dsi.fastutil.chars.Char2LongMap)
*/ 
public static it.unimi.dsi.fastutil.chars.Char2LongMap synchronize(it.unimi.dsi.fastutil.chars.Char2LongMap p0){
	return it.unimi.dsi.fastutil.chars.Char2LongMaps.synchronize(p0);
}
/**
*public static it.unimi.dsi.fastutil.chars.Char2LongMap it.unimi.dsi.fastutil.chars.Char2LongMaps.unmodifiable(it.unimi.dsi.fastutil.chars.Char2LongMap)
*/ 
