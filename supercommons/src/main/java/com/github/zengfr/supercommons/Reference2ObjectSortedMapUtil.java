...
/**
*public static <K,V> it.unimi.dsi.fastutil.objects.Reference2ObjectSortedMap<K, V> it.unimi.dsi.fastutil.objects.Reference2ObjectSortedMaps.emptyMap()
*/ 
public static <K,V> it.unimi.dsi.fastutil.objects.Reference2ObjectSortedMap<K, V> emptyMap(){
	return it.unimi.dsi.fastutil.objects.Reference2ObjectSortedMaps.emptyMap();
}
/**
*public static <K,V> it.unimi.dsi.fastutil.objects.Reference2ObjectSortedMap<K, V> it.unimi.dsi.fastutil.objects.Reference2ObjectSortedMaps.singleton(K,V)
*/ 
public static <K,V> it.unimi.dsi.fastutil.objects.Reference2ObjectSortedMap<K, V> singleton(K p0,V p1){
	return it.unimi.dsi.fastutil.objects.Reference2ObjectSortedMaps.singleton(p0,p1);
}
/**
*public static <K,V> it.unimi.dsi.fastutil.objects.Reference2ObjectSortedMap<K, V> it.unimi.dsi.fastutil.objects.Reference2ObjectSortedMaps.singleton(K,V,java.util.Comparator<? super K>)
*/ 
...
public static <K,V> it.unimi.dsi.fastutil.objects.Reference2ObjectSortedMap<K, V> unmodifiable(it.unimi.dsi.fastutil.objects.Reference2ObjectSortedMap<K, V> p0){
	return it.unimi.dsi.fastutil.objects.Reference2ObjectSortedMaps.unmodifiable(p0);
}
}
