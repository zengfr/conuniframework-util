...
public static <V> it.unimi.dsi.fastutil.objects.ObjectBidirectionalIterable<it.unimi.dsi.fastutil.bytes.Byte2ObjectMap.it.unimi.dsi.fastutil.bytes.Byte2ObjectMap.Entry<V>> fastIterable(it.unimi.dsi.fastutil.bytes.Byte2ObjectSortedMap<V> p0){
return Byte2ObjectSortedMaps.fastIterable(p0);
}
public static <V> it.unimi.dsi.fastutil.objects.ObjectBidirectionalIterable<it.unimi.dsi.fastutil.bytes.Byte2ReferenceMap.it.unimi.dsi.fastutil.bytes.Byte2ReferenceMap.Entry<V>> fastIterable(it.unimi.dsi.fastutil.bytes.Byte2ReferenceSortedMap<V> p0){
return Byte2ReferenceSortedMaps.fastIterable(p0);
}
...
public static <V> it.unimi.dsi.fastutil.objects.ObjectBidirectionalIterable<it.unimi.dsi.fastutil.chars.Char2ObjectMap.it.unimi.dsi.fastutil.chars.Char2ObjectMap.Entry<V>> fastIterable(it.unimi.dsi.fastutil.chars.Char2ObjectSortedMap<V> p0){
return Char2ObjectSortedMaps.fastIterable(p0);
}
public static <V> it.unimi.dsi.fastutil.objects.ObjectBidirectionalIterable<it.unimi.dsi.fastutil.chars.Char2ReferenceMap.it.unimi.dsi.fastutil.chars.Char2ReferenceMap.Entry<V>> fastIterable(it.unimi.dsi.fastutil.chars.Char2ReferenceSortedMap<V> p0){
return Char2ReferenceSortedMaps.fastIterable(p0);
}
...
return Double2BooleanSortedMaps.fastIterable(p0);
}
...
public static <V> it.unimi.dsi.fastutil.objects.ObjectBidirectionalIterable<it.unimi.dsi.fastutil.doubles.Double2ObjectMap.it.unimi.dsi.fastutil.doubles.Double2ObjectMap.Entry<V>> fastIterable(it.unimi.dsi.fastutil.doubles.Double2ObjectSortedMap<V> p0){
return Double2ObjectSortedMaps.fastIterable(p0);
}
public static <V> it.unimi.dsi.fastutil.objects.ObjectBidirectionalIterable<it.unimi.dsi.fastutil.doubles.Double2ReferenceMap.it.unimi.dsi.fastutil.doubles.Double2ReferenceMap.Entry<V>> fastIterable(it.unimi.dsi.fastutil.doubles.Double2ReferenceSortedMap<V> p0){
return Double2ReferenceSortedMaps.fastIterable(p0);
}
...
return Float2BooleanSortedMaps.fastIterable(p0);
}
...
public static <V> it.unimi.dsi.fastutil.objects.ObjectBidirectionalIterable<it.unimi.dsi.fastutil.floats.Float2ObjectMap.it.unimi.dsi.fastutil.floats.Float2ObjectMap.Entry<V>> fastIterable(it.unimi.dsi.fastutil.floats.Float2ObjectSortedMap<V> p0){
return Float2ObjectSortedMaps.fastIterable(p0);
}
public static <V> it.unimi.dsi.fastutil.objects.ObjectBidirectionalIterable<it.unimi.dsi.fastutil.floats.Float2ReferenceMap.it.unimi.dsi.fastutil.floats.Float2ReferenceMap.Entry<V>> fastIterable(it.unimi.dsi.fastutil.floats.Float2ReferenceSortedMap<V> p0){
return Float2ReferenceSortedMaps.fastIterable(p0);
}
...
public static <V> it.unimi.dsi.fastutil.objects.ObjectBidirectionalIterable<it.unimi.dsi.fastutil.ints.Int2ObjectMap.it.unimi.dsi.fastutil.ints.Int2ObjectMap.Entry<V>> fastIterable(it.unimi.dsi.fastutil.ints.Int2ObjectSortedMap<V> p0){
return Int2ObjectSortedMaps.fastIterable(p0);
}
public static <V> it.unimi.dsi.fastutil.objects.ObjectBidirectionalIterable<it.unimi.dsi.fastutil.ints.Int2ReferenceMap.it.unimi.dsi.fastutil.ints.Int2ReferenceMap.Entry<V>> fastIterable(it.unimi.dsi.fastutil.ints.Int2ReferenceSortedMap<V> p0){
return Int2ReferenceSortedMaps.fastIterable(p0);
}
...
public static <V> it.unimi.dsi.fastutil.objects.ObjectBidirectionalIterable<it.unimi.dsi.fastutil.longs.Long2ObjectMap.it.unimi.dsi.fastutil.longs.Long2ObjectMap.Entry<V>> fastIterable(it.unimi.dsi.fastutil.longs.Long2ObjectSortedMap<V> p0){
return Long2ObjectSortedMaps.fastIterable(p0);
}
public static <V> it.unimi.dsi.fastutil.objects.ObjectBidirectionalIterable<it.unimi.dsi.fastutil.longs.Long2ReferenceMap.it.unimi.dsi.fastutil.longs.Long2ReferenceMap.Entry<V>> fastIterable(it.unimi.dsi.fastutil.longs.Long2ReferenceSortedMap<V> p0){
return Long2ReferenceSortedMaps.fastIterable(p0);
}
...
public static <K> it.unimi.dsi.fastutil.objects.ObjectBidirectionalIterable<it.unimi.dsi.fastutil.objects.Object2BooleanMap.it.unimi.dsi.fastutil.objects.Object2BooleanMap.Entry<K>> fastIterable(it.unimi.dsi.fastutil.objects.Object2BooleanSortedMap<K> p0){
return Object2BooleanSortedMaps.fastIterable(p0);
}
public static <K> it.unimi.dsi.fastutil.objects.ObjectBidirectionalIterable<it.unimi.dsi.fastutil.objects.Object2ByteMap.it.unimi.dsi.fastutil.objects.Object2ByteMap.Entry<K>> fastIterable(it.unimi.dsi.fastutil.objects.Object2ByteSortedMap<K> p0){
return Object2ByteSortedMaps.fastIterable(p0);
}
public static <K> it.unimi.dsi.fastutil.objects.ObjectBidirectionalIterable<it.unimi.dsi.fastutil.objects.Object2CharMap.it.unimi.dsi.fastutil.objects.Object2CharMap.Entry<K>> fastIterable(it.unimi.dsi.fastutil.objects.Object2CharSortedMap<K> p0){
return Object2CharSortedMaps.fastIterable(p0);
}
public static <K> it.unimi.dsi.fastutil.objects.ObjectBidirectionalIterable<it.unimi.dsi.fastutil.objects.Object2DoubleMap.it.unimi.dsi.fastutil.objects.Object2DoubleMap.Entry<K>> fastIterable(it.unimi.dsi.fastutil.objects.Object2DoubleSortedMap<K> p0){
return Object2DoubleSortedMaps.fastIterable(p0);
}
public static <K> it.unimi.dsi.fastutil.objects.ObjectBidirectionalIterable<it.unimi.dsi.fastutil.objects.Object2FloatMap.it.unimi.dsi.fastutil.objects.Object2FloatMap.Entry<K>> fastIterable(it.unimi.dsi.fastutil.objects.Object2FloatSortedMap<K> p0){
return Object2FloatSortedMaps.fastIterable(p0);
}
public static <K> it.unimi.dsi.fastutil.objects.ObjectBidirectionalIterable<it.unimi.dsi.fastutil.objects.Object2IntMap.it.unimi.dsi.fastutil.objects.Object2IntMap.Entry<K>> fastIterable(it.unimi.dsi.fastutil.objects.Object2IntSortedMap<K> p0){
return Object2IntSortedMaps.fastIterable(p0);
}
public static <K> it.unimi.dsi.fastutil.objects.ObjectBidirectionalIterable<it.unimi.dsi.fastutil.objects.Object2LongMap.it.unimi.dsi.fastutil.objects.Object2LongMap.Entry<K>> fastIterable(it.unimi.dsi.fastutil.objects.Object2LongSortedMap<K> p0){
return Object2LongSortedMaps.fastIterable(p0);
}
public static <K,V> it.unimi.dsi.fastutil.objects.ObjectBidirectionalIterable<it.unimi.dsi.fastutil.objects.Object2ObjectMap.it.unimi.dsi.fastutil.objects.Object2ObjectMap.Entry<K, V>> fastIterable(it.unimi.dsi.fastutil.objects.Object2ObjectSortedMap<K, V> p0){
return Object2ObjectSortedMaps.fastIterable(p0);
}
public static <K,V> it.unimi.dsi.fastutil.objects.ObjectBidirectionalIterable<it.unimi.dsi.fastutil.objects.Object2ReferenceMap.it.unimi.dsi.fastutil.objects.Object2ReferenceMap.Entry<K, V>> fastIterable(it.unimi.dsi.fastutil.objects.Object2ReferenceSortedMap<K, V> p0){
return Object2ReferenceSortedMaps.fastIterable(p0);
}
public static <K> it.unimi.dsi.fastutil.objects.ObjectBidirectionalIterable<it.unimi.dsi.fastutil.objects.Object2ShortMap.it.unimi.dsi.fastutil.objects.Object2ShortMap.Entry<K>> fastIterable(it.unimi.dsi.fastutil.objects.Object2ShortSortedMap<K> p0){
return Object2ShortSortedMaps.fastIterable(p0);
}
public static <K> it.unimi.dsi.fastutil.objects.ObjectBidirectionalIterable<it.unimi.dsi.fastutil.objects.Reference2BooleanMap.it.unimi.dsi.fastutil.objects.Reference2BooleanMap.Entry<K>> fastIterable(it.unimi.dsi.fastutil.objects.Reference2BooleanSortedMap<K> p0){
return Reference2BooleanSortedMaps.fastIterable(p0);
}
public static <K> it.unimi.dsi.fastutil.objects.ObjectBidirectionalIterable<it.unimi.dsi.fastutil.objects.Reference2ByteMap.it.unimi.dsi.fastutil.objects.Reference2ByteMap.Entry<K>> fastIterable(it.unimi.dsi.fastutil.objects.Reference2ByteSortedMap<K> p0){
return Reference2ByteSortedMaps.fastIterable(p0);
}
public static <K> it.unimi.dsi.fastutil.objects.ObjectBidirectionalIterable<it.unimi.dsi.fastutil.objects.Reference2CharMap.it.unimi.dsi.fastutil.objects.Reference2CharMap.Entry<K>> fastIterable(it.unimi.dsi.fastutil.objects.Reference2CharSortedMap<K> p0){
return Reference2CharSortedMaps.fastIterable(p0);
}
public static <K> it.unimi.dsi.fastutil.objects.ObjectBidirectionalIterable<it.unimi.dsi.fastutil.objects.Reference2DoubleMap.it.unimi.dsi.fastutil.objects.Reference2DoubleMap.Entry<K>> fastIterable(it.unimi.dsi.fastutil.objects.Reference2DoubleSortedMap<K> p0){
return Reference2DoubleSortedMaps.fastIterable(p0);
}
public static <K> it.unimi.dsi.fastutil.objects.ObjectBidirectionalIterable<it.unimi.dsi.fastutil.objects.Reference2FloatMap.it.unimi.dsi.fastutil.objects.Reference2FloatMap.Entry<K>> fastIterable(it.unimi.dsi.fastutil.objects.Reference2FloatSortedMap<K> p0){
return Reference2FloatSortedMaps.fastIterable(p0);
}
public static <K> it.unimi.dsi.fastutil.objects.ObjectBidirectionalIterable<it.unimi.dsi.fastutil.objects.Reference2IntMap.it.unimi.dsi.fastutil.objects.Reference2IntMap.Entry<K>> fastIterable(it.unimi.dsi.fastutil.objects.Reference2IntSortedMap<K> p0){
return Reference2IntSortedMaps.fastIterable(p0);
}
public static <K> it.unimi.dsi.fastutil.objects.ObjectBidirectionalIterable<it.unimi.dsi.fastutil.objects.Reference2LongMap.it.unimi.dsi.fastutil.objects.Reference2LongMap.Entry<K>> fastIterable(it.unimi.dsi.fastutil.objects.Reference2LongSortedMap<K> p0){
return Reference2LongSortedMaps.fastIterable(p0);
}
public static <K,V> it.unimi.dsi.fastutil.objects.ObjectBidirectionalIterable<it.unimi.dsi.fastutil.objects.Reference2ObjectMap.it.unimi.dsi.fastutil.objects.Reference2ObjectMap.Entry<K, V>> fastIterable(it.unimi.dsi.fastutil.objects.Reference2ObjectSortedMap<K, V> p0){
return Reference2ObjectSortedMaps.fastIterable(p0);
}
public static <K,V> it.unimi.dsi.fastutil.objects.ObjectBidirectionalIterable<it.unimi.dsi.fastutil.objects.Reference2ReferenceMap.it.unimi.dsi.fastutil.objects.Reference2ReferenceMap.Entry<K, V>> fastIterable(it.unimi.dsi.fastutil.objects.Reference2ReferenceSortedMap<K, V> p0){
return Reference2ReferenceSortedMaps.fastIterable(p0);
}
public static <K> it.unimi.dsi.fastutil.objects.ObjectBidirectionalIterable<it.unimi.dsi.fastutil.objects.Reference2ShortMap.it.unimi.dsi.fastutil.objects.Reference2ShortMap.Entry<K>> fastIterable(it.unimi.dsi.fastutil.objects.Reference2ShortSortedMap<K> p0){
return Reference2ShortSortedMaps.fastIterable(p0);
}
...
return Short2BooleanSortedMaps.fastIterable(p0);
}
...
public static <V> it.unimi.dsi.fastutil.objects.ObjectBidirectionalIterable<it.unimi.dsi.fastutil.shorts.Short2ObjectMap.it.unimi.dsi.fastutil.shorts.Short2ObjectMap.Entry<V>> fastIterable(it.unimi.dsi.fastutil.shorts.Short2ObjectSortedMap<V> p0){
return Short2ObjectSortedMaps.fastIterable(p0);
}
public static <V> it.unimi.dsi.fastutil.objects.ObjectBidirectionalIterable<it.unimi.dsi.fastutil.shorts.Short2ReferenceMap.it.unimi.dsi.fastutil.shorts.Short2ReferenceMap.Entry<V>> fastIterable(it.unimi.dsi.fastutil.shorts.Short2ReferenceSortedMap<V> p0){
return Short2ReferenceSortedMaps.fastIterable(p0);
}
