...
/**
*public static it.unimi.dsi.fastutil.bytes.Byte2BooleanFunction it.unimi.dsi.fastutil.bytes.Byte2BooleanFunctions.synchronize(it.unimi.dsi.fastutil.bytes.Byte2BooleanFunction)
*/ 
public static it.unimi.dsi.fastutil.bytes.Byte2BooleanFunction synchronize(it.unimi.dsi.fastutil.bytes.Byte2BooleanFunction p0){
	return it.unimi.dsi.fastutil.bytes.Byte2BooleanFunctions.synchronize(p0);
}
/**
*public static it.unimi.dsi.fastutil.bytes.Byte2BooleanFunction it.unimi.dsi.fastutil.bytes.Byte2BooleanFunctions.unmodifiable(it.unimi.dsi.fastutil.bytes.Byte2BooleanFunction)
*/ 
public static it.unimi.dsi.fastutil.bytes.Byte2BooleanFunction unmodifiable(it.unimi.dsi.fastutil.bytes.Byte2BooleanFunction p0){
	return it.unimi.dsi.fastutil.bytes.Byte2BooleanFunctions.unmodifiable(p0);
}
/**
*public static it.unimi.dsi.fastutil.bytes.Byte2BooleanFunction it.unimi.dsi.fastutil.bytes.Byte2BooleanFunctions.primitive(java.util.function.Function<? super java.lang.Byte, ? extends java.lang.Boolean>)
*/ 
public static it.unimi.dsi.fastutil.bytes.Byte2BooleanFunction primitive(java.util.function.Function<? super java.lang.Byte, ? extends java.lang.Boolean> p0){
	return it.unimi.dsi.fastutil.bytes.Byte2BooleanFunctions.primitive(p0);
}
}
