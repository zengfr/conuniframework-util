...
/**
*public static it.unimi.dsi.fastutil.doubles.Double2FloatMap it.unimi.dsi.fastutil.doubles.Double2FloatMaps.singleton(java.lang.Double,java.lang.Float)
*/ 
...
/**
*public static it.unimi.dsi.fastutil.doubles.Double2FloatMap it.unimi.dsi.fastutil.doubles.Double2FloatMaps.synchronize(it.unimi.dsi.fastutil.doubles.Double2FloatMap)
*/ 
public static it.unimi.dsi.fastutil.doubles.Double2FloatMap synchronize(it.unimi.dsi.fastutil.doubles.Double2FloatMap p0){
	return it.unimi.dsi.fastutil.doubles.Double2FloatMaps.synchronize(p0);
}
/**
*public static it.unimi.dsi.fastutil.doubles.Double2FloatMap it.unimi.dsi.fastutil.doubles.Double2FloatMaps.unmodifiable(it.unimi.dsi.fastutil.doubles.Double2FloatMap)
*/ 
