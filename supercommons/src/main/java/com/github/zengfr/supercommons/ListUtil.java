...
/**
*public static <O> java.util.List<O> org.apache.commons.collections4.CollectionUtils.collate(java.lang.Iterable<? extends O>,java.lang.Iterable<? extends O>)
*/ 
...
/**
*public static <S> java.util.List<java.lang.Double> org.apache.commons.math3.genetics.RandomKey.comparatorPermutation(java.util.List<S>,java.util.Comparator<S>)
*/ 
...
/**
*public static java.util.List org.apache.commons.lang.ClassUtils.convertClassNamesToClasses(java.util.List)
*/ 
public static java.util.List convertClassNamesToClasses(java.util.List p0){
	return org.apache.commons.lang.ClassUtils.convertClassNamesToClasses(p0);
}
/**
...
/**
*public static java.util.List org.apache.commons.lang.ClassUtils.convertClassesToClassNames(java.util.List)
*/ 
public static java.util.List convertClassesToClassNames(java.util.List p0){
	return org.apache.commons.lang.ClassUtils.convertClassesToClassNames(p0);
}
/**
*public static <T> java.util.List<T> com.facebook.collectionsbase.Piles.copyOf(java.util.Iterator<T>)
*/ 
...
/**
*public static java.util.List org.apache.commons.collections.list.FixedSizeList.decorate(java.util.List)
*/ 
...
/**
*public static java.util.List org.apache.commons.collections.list.TransformedList.decorate(java.util.List,org.apache.commons.collections.Transformer)
*/ 
...
/**
*public static java.util.List org.apache.commons.collections.ListUtils.fixedSizeList(java.util.List)
*/ 
...
/**
*public static <E> java.util.List<E> org.apache.commons.lang3.EnumUtils.getEnumList(java.lang.Class<E>)
*/ 
...
/**
*public static <S> java.util.List<java.lang.Double> org.apache.commons.math3.genetics.RandomKey.inducedPermutation(java.util.List<S>,java.util.List<S>) throws org.apache.commons.math3.exception.DimensionMismatchException,org.apache.commons.math3.exception.MathIllegalArgumentException
*/ 
...
/**
*public static java.util.List org.apache.commons.collections.ListUtils.intersection(java.util.List,java.util.List)
*/ 
...
/**
*public static org.apache.commons.collections.ResettableListIterator org.apache.commons.collections.IteratorUtils.loopingListIterator(java.util.List)
*/ 
...
/**
*public static <X,Y> java.util.List<Y> com.facebook.collections.ListMapper.map(java.util.List<X>,com.facebook.collectionsbase.Mapper<X, Y>)
*/ 
...
/**
*public static <O,R> java.util.List<R> org.apache.commons.collections4.IterableUtils.partition(java.lang.Iterable<? extends O>,org.apache.commons.collections4.Factory<R>,org.apache.commons.collections4.Predicate<? super O>...)
*/ 
...
/**
*public static java.util.List org.apache.commons.collections.ListUtils.removeAll(java.util.Collection,java.util.Collection)
*/ 
...
/**
*public static java.util.List org.apache.commons.collections.ListUtils.retainAll(java.util.Collection,java.util.Collection)
*/ 
...
/**
*public static java.util.List org.apache.commons.collections.ListUtils.subtract(java.util.List,java.util.List)
*/ 
...
/**
*public static java.util.List org.apache.commons.collections.ListUtils.sum(java.util.List,java.util.List)
*/ 
...
/**
*public static java.util.List org.apache.commons.collections.ListUtils.synchronizedList(java.util.List)
*/ 
...
/**
*public static java.util.List org.apache.commons.collections.ListUtils.transformedList(java.util.List,org.apache.commons.collections.Transformer)
*/ 
...
/**
*public static <X,Y> java.util.List<Y> com.facebook.collectionsbase.Piles.transmogrify(java.util.Iterator<X>,com.google.common.base.Function<X, Y>)
*/ 
...
/**
*public static <X,Y> java.util.List<Y> com.facebook.collectionsbase.Piles.transmogrify(java.util.Iterator<X>,com.facebook.collectionsbase.Mapper<X, Y>)
*/ 
...
/**
*public static java.util.List org.apache.commons.collections.ListUtils.union(java.util.List,java.util.List)
*/ 
...
public static <E> java.util.List<E> unmodifiableList(java.util.List<? extends E> p0){
	return org.apache.commons.collections4.list.UnmodifiableList.unmodifiableList(p0);
}
/**
*public static java.util.List org.apache.commons.collections.ListUtils.unmodifiableList(java.util.List)
*/ 
...
/**
*public static java.util.List<byte[]> com.facebook.collections.PackedByteArray.unpackComparable(byte[])
*/ 
...
/**
*public static java.util.List org.apache.commons.collections.primitives.adapters.ByteListList.wrap(org.apache.commons.collections.primitives.ByteList)
*/ 
...
/**
*public static java.util.List org.apache.commons.collections.primitives.adapters.CharListList.wrap(org.apache.commons.collections.primitives.CharList)
*/ 
...
/**
*public static org.apache.commons.collections.primitives.ByteList org.apache.commons.collections.primitives.adapters.ListByteList.wrap(java.util.List)
*/ 
...
/**
*public static java.util.List org.apache.commons.collections.primitives.adapters.ShortListList.wrap(org.apache.commons.collections.primitives.ShortList)
*/ 
