...
/**
*public static <V> it.unimi.dsi.fastutil.shorts.Short2ObjectSortedMap<V> it.unimi.dsi.fastutil.shorts.Short2ObjectSortedMaps.emptyMap()
*/ 
public static <V> it.unimi.dsi.fastutil.shorts.Short2ObjectSortedMap<V> emptyMap(){
	return it.unimi.dsi.fastutil.shorts.Short2ObjectSortedMaps.emptyMap();
}
/**
*public static <V> it.unimi.dsi.fastutil.shorts.Short2ObjectSortedMap<V> it.unimi.dsi.fastutil.shorts.Short2ObjectSortedMaps.singleton(java.lang.Short,V)
*/ 
public static <V> it.unimi.dsi.fastutil.shorts.Short2ObjectSortedMap<V> singleton(java.lang.Short p0,V p1){
	return it.unimi.dsi.fastutil.shorts.Short2ObjectSortedMaps.singleton(p0,p1);
}
/**
*public static <V> it.unimi.dsi.fastutil.shorts.Short2ObjectSortedMap<V> it.unimi.dsi.fastutil.shorts.Short2ObjectSortedMaps.singleton(short,V)
*/ 
...
/**
*public static <V> it.unimi.dsi.fastutil.shorts.Short2ObjectSortedMap<V> it.unimi.dsi.fastutil.shorts.Short2ObjectSortedMaps.synchronize(it.unimi.dsi.fastutil.shorts.Short2ObjectSortedMap<V>)
*/ 
public static <V> it.unimi.dsi.fastutil.shorts.Short2ObjectSortedMap<V> synchronize(it.unimi.dsi.fastutil.shorts.Short2ObjectSortedMap<V> p0){
	return it.unimi.dsi.fastutil.shorts.Short2ObjectSortedMaps.synchronize(p0);
}
/**
*public static <V> it.unimi.dsi.fastutil.shorts.Short2ObjectSortedMap<V> it.unimi.dsi.fastutil.shorts.Short2ObjectSortedMaps.unmodifiable(it.unimi.dsi.fastutil.shorts.Short2ObjectSortedMap<V>)
*/ 
public static <V> it.unimi.dsi.fastutil.shorts.Short2ObjectSortedMap<V> unmodifiable(it.unimi.dsi.fastutil.shorts.Short2ObjectSortedMap<V> p0){
	return it.unimi.dsi.fastutil.shorts.Short2ObjectSortedMaps.unmodifiable(p0);
}
}
