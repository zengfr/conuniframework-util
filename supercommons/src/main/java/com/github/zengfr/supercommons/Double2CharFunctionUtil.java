...
/**
*public static it.unimi.dsi.fastutil.doubles.Double2CharFunction it.unimi.dsi.fastutil.doubles.Double2CharFunctions.synchronize(it.unimi.dsi.fastutil.doubles.Double2CharFunction)
*/ 
public static it.unimi.dsi.fastutil.doubles.Double2CharFunction synchronize(it.unimi.dsi.fastutil.doubles.Double2CharFunction p0){
	return it.unimi.dsi.fastutil.doubles.Double2CharFunctions.synchronize(p0);
}
/**
*public static it.unimi.dsi.fastutil.doubles.Double2CharFunction it.unimi.dsi.fastutil.doubles.Double2CharFunctions.unmodifiable(it.unimi.dsi.fastutil.doubles.Double2CharFunction)
*/ 
