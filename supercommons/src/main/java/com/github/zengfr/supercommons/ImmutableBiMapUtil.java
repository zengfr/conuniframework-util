...
public static <K,V> com.google.common.collect.ImmutableBiMap<K, V> copyOf(java.util.Map<? extends K, ? extends V> p0){
	return com.google.common.collect.ImmutableBiMap.copyOf(p0);
}
/**
*public static <K,V> com.google.common.collect.ImmutableBiMap<K, V> com.google.common.collect.ImmutableBiMap.copyOf(java.lang.Iterable<? extends java.util.Map.java.util.Map$Entry<? extends K, ? extends V>>)
*/ 
public static <K,V> com.google.common.collect.ImmutableBiMap<K, V> copyOf(java.lang.Iterable<? extends Entry<? extends K, ? extends V>> p0){
	return com.google.common.collect.ImmutableBiMap.copyOf(p0);
}
/**
