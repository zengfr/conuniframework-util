...
/**
*public static <V> it.unimi.dsi.fastutil.doubles.Double2ObjectSortedMap<V> it.unimi.dsi.fastutil.doubles.Double2ObjectSortedMaps.emptyMap()
*/ 
public static <V> it.unimi.dsi.fastutil.doubles.Double2ObjectSortedMap<V> emptyMap(){
	return it.unimi.dsi.fastutil.doubles.Double2ObjectSortedMaps.emptyMap();
}
/**
*public static <V> it.unimi.dsi.fastutil.doubles.Double2ObjectSortedMap<V> it.unimi.dsi.fastutil.doubles.Double2ObjectSortedMaps.singleton(java.lang.Double,V)
*/ 
public static <V> it.unimi.dsi.fastutil.doubles.Double2ObjectSortedMap<V> singleton(java.lang.Double p0,V p1){
	return it.unimi.dsi.fastutil.doubles.Double2ObjectSortedMaps.singleton(p0,p1);
}
/**
*public static <V> it.unimi.dsi.fastutil.doubles.Double2ObjectSortedMap<V> it.unimi.dsi.fastutil.doubles.Double2ObjectSortedMaps.singleton(double,V)
*/ 
...
/**
*public static <V> it.unimi.dsi.fastutil.doubles.Double2ObjectSortedMap<V> it.unimi.dsi.fastutil.doubles.Double2ObjectSortedMaps.synchronize(it.unimi.dsi.fastutil.doubles.Double2ObjectSortedMap<V>)
*/ 
public static <V> it.unimi.dsi.fastutil.doubles.Double2ObjectSortedMap<V> synchronize(it.unimi.dsi.fastutil.doubles.Double2ObjectSortedMap<V> p0){
	return it.unimi.dsi.fastutil.doubles.Double2ObjectSortedMaps.synchronize(p0);
}
/**
*public static <V> it.unimi.dsi.fastutil.doubles.Double2ObjectSortedMap<V> it.unimi.dsi.fastutil.doubles.Double2ObjectSortedMaps.unmodifiable(it.unimi.dsi.fastutil.doubles.Double2ObjectSortedMap<V>)
*/ 
public static <V> it.unimi.dsi.fastutil.doubles.Double2ObjectSortedMap<V> unmodifiable(it.unimi.dsi.fastutil.doubles.Double2ObjectSortedMap<V> p0){
	return it.unimi.dsi.fastutil.doubles.Double2ObjectSortedMaps.unmodifiable(p0);
}
}
