...
/**
*public static it.unimi.dsi.fastutil.chars.Char2BooleanFunction it.unimi.dsi.fastutil.chars.Char2BooleanFunctions.primitive(java.util.function.Function<? super java.lang.Character, ? extends java.lang.Boolean>)
*/ 
public static it.unimi.dsi.fastutil.chars.Char2BooleanFunction primitive(java.util.function.Function<? super java.lang.Character, ? extends java.lang.Boolean> p0){
	return it.unimi.dsi.fastutil.chars.Char2BooleanFunctions.primitive(p0);
}
/**
...
/**
*public static it.unimi.dsi.fastutil.chars.Char2BooleanFunction it.unimi.dsi.fastutil.chars.Char2BooleanFunctions.synchronize(it.unimi.dsi.fastutil.chars.Char2BooleanFunction)
*/ 
public static it.unimi.dsi.fastutil.chars.Char2BooleanFunction synchronize(it.unimi.dsi.fastutil.chars.Char2BooleanFunction p0){
	return it.unimi.dsi.fastutil.chars.Char2BooleanFunctions.synchronize(p0);
}
/**
...
/**
*public static it.unimi.dsi.fastutil.chars.Char2BooleanFunction it.unimi.dsi.fastutil.chars.Char2BooleanFunctions.unmodifiable(it.unimi.dsi.fastutil.chars.Char2BooleanFunction)
*/ 
public static it.unimi.dsi.fastutil.chars.Char2BooleanFunction unmodifiable(it.unimi.dsi.fastutil.chars.Char2BooleanFunction p0){
	return it.unimi.dsi.fastutil.chars.Char2BooleanFunctions.unmodifiable(p0);
}
}
