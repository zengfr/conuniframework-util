...
/**
*public static <K> it.unimi.dsi.fastutil.objects.Object2DoubleFunction<K> it.unimi.dsi.fastutil.objects.Object2DoubleFunctions.synchronize(it.unimi.dsi.fastutil.objects.Object2DoubleFunction<K>)
*/ 
public static <K> it.unimi.dsi.fastutil.objects.Object2DoubleFunction<K> synchronize(it.unimi.dsi.fastutil.objects.Object2DoubleFunction<K> p0){
	return it.unimi.dsi.fastutil.objects.Object2DoubleFunctions.synchronize(p0);
}
/**
*public static <K> it.unimi.dsi.fastutil.objects.Object2DoubleFunction<K> it.unimi.dsi.fastutil.objects.Object2DoubleFunctions.unmodifiable(it.unimi.dsi.fastutil.objects.Object2DoubleFunction<K>)
*/ 
