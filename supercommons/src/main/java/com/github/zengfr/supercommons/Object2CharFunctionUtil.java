...
/**
*public static <K> it.unimi.dsi.fastutil.objects.Object2CharFunction<K> it.unimi.dsi.fastutil.objects.Object2CharFunctions.synchronize(it.unimi.dsi.fastutil.objects.Object2CharFunction<K>)
*/ 
public static <K> it.unimi.dsi.fastutil.objects.Object2CharFunction<K> synchronize(it.unimi.dsi.fastutil.objects.Object2CharFunction<K> p0){
	return it.unimi.dsi.fastutil.objects.Object2CharFunctions.synchronize(p0);
}
/**
*public static <K> it.unimi.dsi.fastutil.objects.Object2CharFunction<K> it.unimi.dsi.fastutil.objects.Object2CharFunctions.unmodifiable(it.unimi.dsi.fastutil.objects.Object2CharFunction<K>)
*/ 
