...
/**
*public static <V> it.unimi.dsi.fastutil.longs.Long2ObjectSortedMap<V> it.unimi.dsi.fastutil.longs.Long2ObjectSortedMaps.emptyMap()
*/ 
public static <V> it.unimi.dsi.fastutil.longs.Long2ObjectSortedMap<V> emptyMap(){
	return it.unimi.dsi.fastutil.longs.Long2ObjectSortedMaps.emptyMap();
}
/**
*public static <V> it.unimi.dsi.fastutil.longs.Long2ObjectSortedMap<V> it.unimi.dsi.fastutil.longs.Long2ObjectSortedMaps.singleton(java.lang.Long,V)
*/ 
public static <V> it.unimi.dsi.fastutil.longs.Long2ObjectSortedMap<V> singleton(java.lang.Long p0,V p1){
	return it.unimi.dsi.fastutil.longs.Long2ObjectSortedMaps.singleton(p0,p1);
}
/**
*public static <V> it.unimi.dsi.fastutil.longs.Long2ObjectSortedMap<V> it.unimi.dsi.fastutil.longs.Long2ObjectSortedMaps.singleton(long,V)
*/ 
...
/**
*public static <V> it.unimi.dsi.fastutil.longs.Long2ObjectSortedMap<V> it.unimi.dsi.fastutil.longs.Long2ObjectSortedMaps.synchronize(it.unimi.dsi.fastutil.longs.Long2ObjectSortedMap<V>)
*/ 
public static <V> it.unimi.dsi.fastutil.longs.Long2ObjectSortedMap<V> synchronize(it.unimi.dsi.fastutil.longs.Long2ObjectSortedMap<V> p0){
	return it.unimi.dsi.fastutil.longs.Long2ObjectSortedMaps.synchronize(p0);
}
/**
*public static <V> it.unimi.dsi.fastutil.longs.Long2ObjectSortedMap<V> it.unimi.dsi.fastutil.longs.Long2ObjectSortedMaps.unmodifiable(it.unimi.dsi.fastutil.longs.Long2ObjectSortedMap<V>)
*/ 
public static <V> it.unimi.dsi.fastutil.longs.Long2ObjectSortedMap<V> unmodifiable(it.unimi.dsi.fastutil.longs.Long2ObjectSortedMap<V> p0){
	return it.unimi.dsi.fastutil.longs.Long2ObjectSortedMaps.unmodifiable(p0);
}
}
