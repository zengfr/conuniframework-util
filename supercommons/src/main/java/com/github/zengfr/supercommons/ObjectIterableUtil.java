...
public static <V> it.unimi.dsi.fastutil.objects.ObjectIterable<it.unimi.dsi.fastutil.bytes.Byte2ObjectMap.it.unimi.dsi.fastutil.bytes.Byte2ObjectMap.Entry<V>> fastIterable(it.unimi.dsi.fastutil.bytes.Byte2ObjectMap<V> p0){
return Byte2ObjectMaps.fastIterable(p0);
}
public static <V> it.unimi.dsi.fastutil.objects.ObjectIterable<it.unimi.dsi.fastutil.bytes.Byte2ReferenceMap.it.unimi.dsi.fastutil.bytes.Byte2ReferenceMap.Entry<V>> fastIterable(it.unimi.dsi.fastutil.bytes.Byte2ReferenceMap<V> p0){
return Byte2ReferenceMaps.fastIterable(p0);
}
...
public static <V> it.unimi.dsi.fastutil.objects.ObjectIterable<it.unimi.dsi.fastutil.chars.Char2ObjectMap.it.unimi.dsi.fastutil.chars.Char2ObjectMap.Entry<V>> fastIterable(it.unimi.dsi.fastutil.chars.Char2ObjectMap<V> p0){
return Char2ObjectMaps.fastIterable(p0);
}
public static <V> it.unimi.dsi.fastutil.objects.ObjectIterable<it.unimi.dsi.fastutil.chars.Char2ReferenceMap.it.unimi.dsi.fastutil.chars.Char2ReferenceMap.Entry<V>> fastIterable(it.unimi.dsi.fastutil.chars.Char2ReferenceMap<V> p0){
return Char2ReferenceMaps.fastIterable(p0);
}
...
public static <V> it.unimi.dsi.fastutil.objects.ObjectIterable<it.unimi.dsi.fastutil.doubles.Double2ObjectMap.it.unimi.dsi.fastutil.doubles.Double2ObjectMap.Entry<V>> fastIterable(it.unimi.dsi.fastutil.doubles.Double2ObjectMap<V> p0){
return Double2ObjectMaps.fastIterable(p0);
}
public static <V> it.unimi.dsi.fastutil.objects.ObjectIterable<it.unimi.dsi.fastutil.doubles.Double2ReferenceMap.it.unimi.dsi.fastutil.doubles.Double2ReferenceMap.Entry<V>> fastIterable(it.unimi.dsi.fastutil.doubles.Double2ReferenceMap<V> p0){
return Double2ReferenceMaps.fastIterable(p0);
}
...
public static <V> it.unimi.dsi.fastutil.objects.ObjectIterable<it.unimi.dsi.fastutil.floats.Float2ObjectMap.it.unimi.dsi.fastutil.floats.Float2ObjectMap.Entry<V>> fastIterable(it.unimi.dsi.fastutil.floats.Float2ObjectMap<V> p0){
return Float2ObjectMaps.fastIterable(p0);
}
public static <V> it.unimi.dsi.fastutil.objects.ObjectIterable<it.unimi.dsi.fastutil.floats.Float2ReferenceMap.it.unimi.dsi.fastutil.floats.Float2ReferenceMap.Entry<V>> fastIterable(it.unimi.dsi.fastutil.floats.Float2ReferenceMap<V> p0){
return Float2ReferenceMaps.fastIterable(p0);
}
...
public static <V> it.unimi.dsi.fastutil.objects.ObjectIterable<it.unimi.dsi.fastutil.ints.Int2ObjectMap.it.unimi.dsi.fastutil.ints.Int2ObjectMap.Entry<V>> fastIterable(it.unimi.dsi.fastutil.ints.Int2ObjectMap<V> p0){
return Int2ObjectMaps.fastIterable(p0);
}
public static <V> it.unimi.dsi.fastutil.objects.ObjectIterable<it.unimi.dsi.fastutil.ints.Int2ReferenceMap.it.unimi.dsi.fastutil.ints.Int2ReferenceMap.Entry<V>> fastIterable(it.unimi.dsi.fastutil.ints.Int2ReferenceMap<V> p0){
return Int2ReferenceMaps.fastIterable(p0);
}
...
public static <V> it.unimi.dsi.fastutil.objects.ObjectIterable<it.unimi.dsi.fastutil.longs.Long2ObjectMap.it.unimi.dsi.fastutil.longs.Long2ObjectMap.Entry<V>> fastIterable(it.unimi.dsi.fastutil.longs.Long2ObjectMap<V> p0){
return Long2ObjectMaps.fastIterable(p0);
}
public static <V> it.unimi.dsi.fastutil.objects.ObjectIterable<it.unimi.dsi.fastutil.longs.Long2ReferenceMap.it.unimi.dsi.fastutil.longs.Long2ReferenceMap.Entry<V>> fastIterable(it.unimi.dsi.fastutil.longs.Long2ReferenceMap<V> p0){
return Long2ReferenceMaps.fastIterable(p0);
}
...
public static <K> it.unimi.dsi.fastutil.objects.ObjectIterable<it.unimi.dsi.fastutil.objects.Object2BooleanMap.it.unimi.dsi.fastutil.objects.Object2BooleanMap.Entry<K>> fastIterable(it.unimi.dsi.fastutil.objects.Object2BooleanMap<K> p0){
return Object2BooleanMaps.fastIterable(p0);
}
public static <K> it.unimi.dsi.fastutil.objects.ObjectIterable<it.unimi.dsi.fastutil.objects.Object2ByteMap.it.unimi.dsi.fastutil.objects.Object2ByteMap.Entry<K>> fastIterable(it.unimi.dsi.fastutil.objects.Object2ByteMap<K> p0){
return Object2ByteMaps.fastIterable(p0);
}
public static <K> it.unimi.dsi.fastutil.objects.ObjectIterable<it.unimi.dsi.fastutil.objects.Object2CharMap.it.unimi.dsi.fastutil.objects.Object2CharMap.Entry<K>> fastIterable(it.unimi.dsi.fastutil.objects.Object2CharMap<K> p0){
return Object2CharMaps.fastIterable(p0);
}
public static <K> it.unimi.dsi.fastutil.objects.ObjectIterable<it.unimi.dsi.fastutil.objects.Object2DoubleMap.it.unimi.dsi.fastutil.objects.Object2DoubleMap.Entry<K>> fastIterable(it.unimi.dsi.fastutil.objects.Object2DoubleMap<K> p0){
return Object2DoubleMaps.fastIterable(p0);
}
public static <K> it.unimi.dsi.fastutil.objects.ObjectIterable<it.unimi.dsi.fastutil.objects.Object2FloatMap.it.unimi.dsi.fastutil.objects.Object2FloatMap.Entry<K>> fastIterable(it.unimi.dsi.fastutil.objects.Object2FloatMap<K> p0){
return Object2FloatMaps.fastIterable(p0);
}
public static <K> it.unimi.dsi.fastutil.objects.ObjectIterable<it.unimi.dsi.fastutil.objects.Object2IntMap.it.unimi.dsi.fastutil.objects.Object2IntMap.Entry<K>> fastIterable(it.unimi.dsi.fastutil.objects.Object2IntMap<K> p0){
return Object2IntMaps.fastIterable(p0);
}
public static <K> it.unimi.dsi.fastutil.objects.ObjectIterable<it.unimi.dsi.fastutil.objects.Object2LongMap.it.unimi.dsi.fastutil.objects.Object2LongMap.Entry<K>> fastIterable(it.unimi.dsi.fastutil.objects.Object2LongMap<K> p0){
return Object2LongMaps.fastIterable(p0);
}
public static <K,V> it.unimi.dsi.fastutil.objects.ObjectIterable<it.unimi.dsi.fastutil.objects.Object2ObjectMap.it.unimi.dsi.fastutil.objects.Object2ObjectMap.Entry<K, V>> fastIterable(it.unimi.dsi.fastutil.objects.Object2ObjectMap<K, V> p0){
return Object2ObjectMaps.fastIterable(p0);
}
public static <K,V> it.unimi.dsi.fastutil.objects.ObjectIterable<it.unimi.dsi.fastutil.objects.Object2ReferenceMap.it.unimi.dsi.fastutil.objects.Object2ReferenceMap.Entry<K, V>> fastIterable(it.unimi.dsi.fastutil.objects.Object2ReferenceMap<K, V> p0){
return Object2ReferenceMaps.fastIterable(p0);
}
public static <K> it.unimi.dsi.fastutil.objects.ObjectIterable<it.unimi.dsi.fastutil.objects.Object2ShortMap.it.unimi.dsi.fastutil.objects.Object2ShortMap.Entry<K>> fastIterable(it.unimi.dsi.fastutil.objects.Object2ShortMap<K> p0){
return Object2ShortMaps.fastIterable(p0);
}
public static <K> it.unimi.dsi.fastutil.objects.ObjectIterable<it.unimi.dsi.fastutil.objects.Reference2BooleanMap.it.unimi.dsi.fastutil.objects.Reference2BooleanMap.Entry<K>> fastIterable(it.unimi.dsi.fastutil.objects.Reference2BooleanMap<K> p0){
return Reference2BooleanMaps.fastIterable(p0);
}
public static <K> it.unimi.dsi.fastutil.objects.ObjectIterable<it.unimi.dsi.fastutil.objects.Reference2ByteMap.it.unimi.dsi.fastutil.objects.Reference2ByteMap.Entry<K>> fastIterable(it.unimi.dsi.fastutil.objects.Reference2ByteMap<K> p0){
return Reference2ByteMaps.fastIterable(p0);
}
public static <K> it.unimi.dsi.fastutil.objects.ObjectIterable<it.unimi.dsi.fastutil.objects.Reference2CharMap.it.unimi.dsi.fastutil.objects.Reference2CharMap.Entry<K>> fastIterable(it.unimi.dsi.fastutil.objects.Reference2CharMap<K> p0){
return Reference2CharMaps.fastIterable(p0);
}
public static <K> it.unimi.dsi.fastutil.objects.ObjectIterable<it.unimi.dsi.fastutil.objects.Reference2DoubleMap.it.unimi.dsi.fastutil.objects.Reference2DoubleMap.Entry<K>> fastIterable(it.unimi.dsi.fastutil.objects.Reference2DoubleMap<K> p0){
return Reference2DoubleMaps.fastIterable(p0);
}
public static <K> it.unimi.dsi.fastutil.objects.ObjectIterable<it.unimi.dsi.fastutil.objects.Reference2FloatMap.it.unimi.dsi.fastutil.objects.Reference2FloatMap.Entry<K>> fastIterable(it.unimi.dsi.fastutil.objects.Reference2FloatMap<K> p0){
return Reference2FloatMaps.fastIterable(p0);
}
public static <K> it.unimi.dsi.fastutil.objects.ObjectIterable<it.unimi.dsi.fastutil.objects.Reference2IntMap.it.unimi.dsi.fastutil.objects.Reference2IntMap.Entry<K>> fastIterable(it.unimi.dsi.fastutil.objects.Reference2IntMap<K> p0){
return Reference2IntMaps.fastIterable(p0);
}
public static <K> it.unimi.dsi.fastutil.objects.ObjectIterable<it.unimi.dsi.fastutil.objects.Reference2LongMap.it.unimi.dsi.fastutil.objects.Reference2LongMap.Entry<K>> fastIterable(it.unimi.dsi.fastutil.objects.Reference2LongMap<K> p0){
return Reference2LongMaps.fastIterable(p0);
}
public static <K,V> it.unimi.dsi.fastutil.objects.ObjectIterable<it.unimi.dsi.fastutil.objects.Reference2ObjectMap.it.unimi.dsi.fastutil.objects.Reference2ObjectMap.Entry<K, V>> fastIterable(it.unimi.dsi.fastutil.objects.Reference2ObjectMap<K, V> p0){
return Reference2ObjectMaps.fastIterable(p0);
}
public static <K,V> it.unimi.dsi.fastutil.objects.ObjectIterable<it.unimi.dsi.fastutil.objects.Reference2ReferenceMap.it.unimi.dsi.fastutil.objects.Reference2ReferenceMap.Entry<K, V>> fastIterable(it.unimi.dsi.fastutil.objects.Reference2ReferenceMap<K, V> p0){
return Reference2ReferenceMaps.fastIterable(p0);
}
public static <K> it.unimi.dsi.fastutil.objects.ObjectIterable<it.unimi.dsi.fastutil.objects.Reference2ShortMap.it.unimi.dsi.fastutil.objects.Reference2ShortMap.Entry<K>> fastIterable(it.unimi.dsi.fastutil.objects.Reference2ShortMap<K> p0){
return Reference2ShortMaps.fastIterable(p0);
}
...
public static <V> it.unimi.dsi.fastutil.objects.ObjectIterable<it.unimi.dsi.fastutil.shorts.Short2ObjectMap.it.unimi.dsi.fastutil.shorts.Short2ObjectMap.Entry<V>> fastIterable(it.unimi.dsi.fastutil.shorts.Short2ObjectMap<V> p0){
return Short2ObjectMaps.fastIterable(p0);
}
public static <V> it.unimi.dsi.fastutil.objects.ObjectIterable<it.unimi.dsi.fastutil.shorts.Short2ReferenceMap.it.unimi.dsi.fastutil.shorts.Short2ReferenceMap.Entry<V>> fastIterable(it.unimi.dsi.fastutil.shorts.Short2ReferenceMap<V> p0){
return Short2ReferenceMaps.fastIterable(p0);
}
public static it.unimi.dsi.fastutil.objects.ObjectIterable<it.unimi.dsi.fastutil.shorts.Short2ShortMap.Entry> fastIterable(it.unimi.dsi.fastutil.shorts.Short2ShortMap p0){
return Short2ShortMaps.fastIterable(p0);
}
}
