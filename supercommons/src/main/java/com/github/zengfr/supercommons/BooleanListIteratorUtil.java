...
public static it.unimi.dsi.fastutil.booleans.BooleanListIterator singleton(boolean p0){
	return it.unimi.dsi.fastutil.booleans.BooleanIterators.singleton(p0);
}
/**
*public static it.unimi.dsi.fastutil.booleans.BooleanListIterator it.unimi.dsi.fastutil.booleans.BooleanIterators.unmodifiable(it.unimi.dsi.fastutil.booleans.BooleanListIterator)
*/ 
