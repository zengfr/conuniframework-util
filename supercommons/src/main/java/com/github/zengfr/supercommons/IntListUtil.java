...
/**
*public static it.unimi.dsi.fastutil.ints.IntList it.unimi.dsi.fastutil.ints.IntLists.singleton(int)
*/ 
public static it.unimi.dsi.fastutil.ints.IntList singleton(int p0){
	return it.unimi.dsi.fastutil.ints.IntLists.singleton(p0);
}
/**
*public static it.unimi.dsi.fastutil.ints.IntList it.unimi.dsi.fastutil.ints.IntLists.singleton(java.lang.Object)
*/ 
...
/**
*public static it.unimi.dsi.fastutil.ints.IntList it.unimi.dsi.fastutil.ints.IntLists.unmodifiable(it.unimi.dsi.fastutil.ints.IntList)
*/ 
