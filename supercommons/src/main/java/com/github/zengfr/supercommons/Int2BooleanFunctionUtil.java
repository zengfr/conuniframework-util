...
/**
*public static it.unimi.dsi.fastutil.ints.Int2BooleanFunction it.unimi.dsi.fastutil.ints.Int2BooleanFunctions.primitive(java.util.function.Function<? super java.lang.Integer, ? extends java.lang.Boolean>)
*/ 
public static it.unimi.dsi.fastutil.ints.Int2BooleanFunction primitive(java.util.function.Function<? super java.lang.Integer, ? extends java.lang.Boolean> p0){
	return it.unimi.dsi.fastutil.ints.Int2BooleanFunctions.primitive(p0);
}
/**
...
/**
*public static it.unimi.dsi.fastutil.ints.Int2BooleanFunction it.unimi.dsi.fastutil.ints.Int2BooleanFunctions.synchronize(it.unimi.dsi.fastutil.ints.Int2BooleanFunction)
*/ 
public static it.unimi.dsi.fastutil.ints.Int2BooleanFunction synchronize(it.unimi.dsi.fastutil.ints.Int2BooleanFunction p0){
	return it.unimi.dsi.fastutil.ints.Int2BooleanFunctions.synchronize(p0);
}
/**
...
/**
*public static it.unimi.dsi.fastutil.ints.Int2BooleanFunction it.unimi.dsi.fastutil.ints.Int2BooleanFunctions.unmodifiable(it.unimi.dsi.fastutil.ints.Int2BooleanFunction)
*/ 
public static it.unimi.dsi.fastutil.ints.Int2BooleanFunction unmodifiable(it.unimi.dsi.fastutil.ints.Int2BooleanFunction p0){
	return it.unimi.dsi.fastutil.ints.Int2BooleanFunctions.unmodifiable(p0);
}
}
