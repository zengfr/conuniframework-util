...
return ImmutableSetMultimap.copyOf(p0);
}
public static <K,V> com.google.common.collect.ImmutableSetMultimap<K, V> copyOf(java.lang.Iterable<? extends java.util.Map.java.util.Map.Entry<? extends K, ? extends V>> p0){
return ImmutableSetMultimap.copyOf(p0);
}
...
return ImmutableSetMultimap.of(p0,p1,p2,p3,p4,p5,p6,p7,p8,p9);
}
public static <K,V> com.google.common.collect.ImmutableSetMultimap<K, V> of(K p0,V p1,K p2,V p3){
return ImmutableSetMultimap.of(p0,p1,p2,p3);
}
}
