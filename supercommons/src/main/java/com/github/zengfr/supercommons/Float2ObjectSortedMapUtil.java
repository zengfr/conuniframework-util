...
/**
*public static <V> it.unimi.dsi.fastutil.floats.Float2ObjectSortedMap<V> it.unimi.dsi.fastutil.floats.Float2ObjectSortedMaps.emptyMap()
*/ 
public static <V> it.unimi.dsi.fastutil.floats.Float2ObjectSortedMap<V> emptyMap(){
	return it.unimi.dsi.fastutil.floats.Float2ObjectSortedMaps.emptyMap();
}
/**
*public static <V> it.unimi.dsi.fastutil.floats.Float2ObjectSortedMap<V> it.unimi.dsi.fastutil.floats.Float2ObjectSortedMaps.singleton(java.lang.Float,V)
*/ 
public static <V> it.unimi.dsi.fastutil.floats.Float2ObjectSortedMap<V> singleton(java.lang.Float p0,V p1){
	return it.unimi.dsi.fastutil.floats.Float2ObjectSortedMaps.singleton(p0,p1);
}
/**
*public static <V> it.unimi.dsi.fastutil.floats.Float2ObjectSortedMap<V> it.unimi.dsi.fastutil.floats.Float2ObjectSortedMaps.singleton(float,V)
*/ 
...
/**
*public static <V> it.unimi.dsi.fastutil.floats.Float2ObjectSortedMap<V> it.unimi.dsi.fastutil.floats.Float2ObjectSortedMaps.synchronize(it.unimi.dsi.fastutil.floats.Float2ObjectSortedMap<V>)
*/ 
public static <V> it.unimi.dsi.fastutil.floats.Float2ObjectSortedMap<V> synchronize(it.unimi.dsi.fastutil.floats.Float2ObjectSortedMap<V> p0){
	return it.unimi.dsi.fastutil.floats.Float2ObjectSortedMaps.synchronize(p0);
}
/**
*public static <V> it.unimi.dsi.fastutil.floats.Float2ObjectSortedMap<V> it.unimi.dsi.fastutil.floats.Float2ObjectSortedMaps.unmodifiable(it.unimi.dsi.fastutil.floats.Float2ObjectSortedMap<V>)
*/ 
public static <V> it.unimi.dsi.fastutil.floats.Float2ObjectSortedMap<V> unmodifiable(it.unimi.dsi.fastutil.floats.Float2ObjectSortedMap<V> p0){
	return it.unimi.dsi.fastutil.floats.Float2ObjectSortedMaps.unmodifiable(p0);
}
}
